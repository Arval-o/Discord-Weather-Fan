...
# Day 2/3 embed (combined if both exist)
if day2_to_post or day3_to_post:
    description = ""
    for entry, day in [(day2_to_post, "Day 2"), (day3_to_post, "Day 3")]:
        if entry:
            description += f"**{day} Convective Outlook**\n[{entry.title}]({entry.link})\n\n"

            # Update last_id
            last_id[day[-1]] = entry.id  # "2" or "3"
    embed = {
